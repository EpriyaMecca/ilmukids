      ...
      🌟 Semangat belajar hari ini, tetap istiqomah!
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm text-center">
            ...
            <div className="text-xs text-gray-500 mt-1">Quiz Tersedia</div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-bold text-gray-800">Quiz Tersedia 🎮</h3>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {daftarQuiz.map((quiz) => (
                ...
                >
                  ...
                  <div className="mt-4 w-full bg-green-500 hover:bg-green-600 text-white py-2.5 rounded-xl font-semibold text-sm text-center transition-colors">
                    Mulai Quiz →
                  </div>
                </Link>
              ))}
